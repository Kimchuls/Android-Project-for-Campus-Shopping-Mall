...
public class MiniProgressLoaderFactory implements IProgressLoaderFactory {
    ...
    public IProgressLoader create(Context context) {
        return new com.example.supermarket_1_0.core.http.loader.MiniLoadingDialogLoader(context);
    }

    @Override
    public IProgressLoader create(Context context, String message) {
        return new com.example.supermarket_1_0.core.http.loader.MiniLoadingDialogLoader(context, message);
    }
}
