...
import com.example.supermarket_1_0.adapter.base.delegate.SingleDelegateAdapter;
...
public class NewsFragment extends BaseFragment {
    ...
    protected void initViews() {
        ...
        SimpleDelegateAdapter<AdapterItem> commonAdapter = new SimpleDelegateAdapter<AdapterItem>(R.layout.adapter_common_grid_item, gridLayoutHelper, DemoDataProvider.getGridItems(getContext())) {
            ...
            protected void bindData(@NonNull RecyclerViewHolder holder, int position, AdapterItem item) {
                if (item != null) {
                    ...
                    param.putString("tab", String.format("%d",position));
                    holder.click(R.id.ll_container, v -> getActivity().getSupportFragmentManager()
                            .beginTransaction()
                            .replace(R.id.fragment_news, new ShoppingFragment(), null)
                            .addToBackStack(null)
                            .commit());*/
                }
            }
        ...
        SingleDelegateAdapter titleAdapter = new SingleDelegateAdapter(R.layout.adapter_title_item) {
            @Override
            public void onBindViewHolder(@NonNull RecyclerViewHolder holder, int position) {
                holder.text(R.id.tv_title, "本期推介[广告]");
        ...
        mNewsAdapter = new SimpleDelegateAdapter<NewInfo>(R.layout.adapter_news_card_view_list_item, new LinearLayoutHelper()) {
            ...
            protected void bindData(@NonNull RecyclerViewHolder holder, int position, NewInfo model) {
                if (model != null) {
                    ...
                    //holder.click(R.id.card_view, v -> Log.e("url",model.getDetailUrl()));
                }
            }
        };
    ...
    protected void initListeners() {
        ...
        refreshLayout.setOnRefreshListener(refreshLayout -> {
            ...
            refreshLayout.getLayout().postDelayed(() -> {
                mNewsAdapter.refresh(DemoDataProvider.getDemoNewInfos(1));
        ...
        refreshLayout.setOnLoadMoreListener(refreshLayout -> {
            // TODO: 2020-02-25 这里只是模拟了网络请求
            refreshLayout.getLayout().postDelayed(() -> {
                mNewsAdapter.loadMore(DemoDataProvider.getDemoNewInfos(1));
