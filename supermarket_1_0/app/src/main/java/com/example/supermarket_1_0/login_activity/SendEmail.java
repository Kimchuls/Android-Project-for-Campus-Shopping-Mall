...
public class SendEmail {
    ...
    // 发件人
    private String from = "jincz2000@126.com";
    // 收件人
    private String to = "1007552535@qq.com";
    // 初始化连接邮件服务器的会话信息
    ...
    public void sendTextEmail(long Num) throws Exception {
        ...
        // 打开连接
        transport.connect("jincz2000", "RUNSQTQECRPFHXPA");
    ...
    public void sendHtmlEmail(long Num) throws Exception {
        ...
        MimeMessage message = new MimeMessage(session);
        // 设置邮件主题
        message.setSubject("校园超市App的注册验证码");
        // 设置发送人
        message.setFrom(new InternetAddress(from));
        // 设置发送时间
        message.setSentDate(new Date());
    ...
    static class MyAuthenticator extends Authenticator {
        ...
        private String username = "jincz2000";

        private String password = "RUNSQTQECRPFHXPA";
