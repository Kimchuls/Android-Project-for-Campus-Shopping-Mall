...
import com.example.supermarket_1_0.core.http.loader.AgentWebActivity;
...
import static com.example.supermarket_1_0.core.http.loader.AgentWebActivity.KEY_URL;
 ...
 */
public final class UtilsForNet {
    ...
    public static void goProduct(Context context, String userid,String data) {
